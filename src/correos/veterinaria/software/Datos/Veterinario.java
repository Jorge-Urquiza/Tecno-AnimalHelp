...
public class Veterinario {
    ...
    public void setVeterinario(String nombre, String apellidos, int ci, String celular, String direccion) {
        this.nombre = nombre;
    ...
    public void setVeterinario(int id, String nombre, String apellidos, int ci, String celular, String direccion) {
        this.id = id;
        this.nombre = nombre;
        this.apellido = apellidos;
        this.ci = ci;
    ...
    public void eliminar() {
        ...
        PreparedStatement ps = null;
        try {
            ps = con.prepareStatement("DELETE FROM veterinarios WHERE id = ?");
            ps.setInt(1, this.id);
            ps.executeUpdate();
